...
function Art_col() {
  return (
    <>
    <section className="Art_collection flex justify-center items-center my-14">
        <div className=" w-[80%] container block">
        <div className=" heading md:flex justify-between block text-center ">
            <div className="title text-2xl font-bold">World Best vintage Hand Made Art Collection</div>
